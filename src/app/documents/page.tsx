...
const categories = [
  ...
  { id: "contracts", label: "Contracts/HR" },
];
...
const documents = [
  ...
  },
  {
    ...
    description: "Social media rules",
    category: "community",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="hidden sm:flex justify-center mb-4">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/50 backdrop-blur-sm blur-fix border border-border/50">
              ...
              <span className="text-xs text-muted-foreground">31 documents</span>
            </div>
          </div>
